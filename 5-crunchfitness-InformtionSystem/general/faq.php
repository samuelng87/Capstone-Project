      ...
      <!-- Wrap the rest of the page in another container to center all the content. -->
        ...
        <div class="container faq-container">
            ...
            <div class="faq-content content">
              <p>
                You have to see it to believe it - the Crunch value will blow your mind. You can get a free trial pass here. As we are a member's club there are a few things to consider as a guest; you must be 18 years or older and a first-time visitor to Crunch. You'll need to sign in, please present a Photo ID to prove that you are a resident of the state. Plus bring a workout towel and locker padlock if you want to store your valuables.
              </p>
            </div>
            ...
            <div class="faq-content content">
              <p>
                Simply book in your preferred time and day here and we will have one of our friendly Crunch team on stand-by to show you around. And feel free to take a virtual tour of your preferred club right here.
              </p>
            </div>
            ...
            <div class="faq-content content">
              <p>
                At Crunch we're not only about No Judgments - we're also about no pressure! Our teams are not paid sales commissions, they genuinely just want to show you all that makes Crunch special - then we leave it up to you to decide. We know from helping thousands of members that the Crunch value cannot be beaten.
              </p>
            </div>
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
            ...
            <div class="faq-content content">
              <p>
                Absolutely everything! We want you to experience ALL Crunch has to offer with no judgments and no limits! Try all our latest strength and cardio equipment, get a taste of our world famous classes and experience true relaxation and recovery with a Hydromassage session and Theragun percussive massage!
              </p>
            </div>
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
            ...
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
                Is Crunch Fitness 24/7?	

            </button>
            <div class="faq-content content">
              <p>
                Crunch's opening hours are extensive and supports the needs of over 97% of gym goers, we are not 24/7. Our priority is to provide personalised service by staff who ensure that our clubs are always safe, fresh & clean and pumping with good vibes. Nothing great happens after midnight hehe.
              </p>
            </div>
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
            ...
            <div class="faq-content content">
              <p>
                It's one of the most popular benefits of our Summit Membership. You can bring in a buddy to train with you for free at any time. It's like a 'two for one' kinda deal. Your buddy can be the same person or a different person each time. You'll need to check your buddy in to the club when you check in and ensure they follow our guests and club etiquette to keep everyone safe and happy. Our experience tells us that having a workout buddy increases your results by at least 50%.
              </p>
            </div>
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
            ...
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
                How do I get started on a membership at Crunch?
            </button>
            <div class="faq-content content">
              <p>
                We've taken the yucky out of getting started at a gym. Our memberships are easy to understand and created to fit your specific needs so once you decide, you can get started online right here. Follow the easy steps to enrol and you will be emailed your membership and next steps to get on your way to smashing your goals with us.
                If you need a little more help, our team stand ready to welcome you and help you at the club of your choice. Either walk-in or book a time and someone will be there to show you around and help you out.
              </p>
            </div>
            <button type="button" class="faq-collapsible collapsible dropdown-toggle">
            ...
            <div class="faq-content content">
              <p>
                ...
                us offering more special rates. To see what's available please enquire at a club.
              </p>
            </div>
