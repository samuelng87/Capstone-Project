...
<html lang="en">
  ...
  <body>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h1>Welcome to Crunch Fitness</h1>
              <p>$0 Enrolment* | Only $7.95/week* | Offer ends Wed 18th Jan</p>
          ...
          <div class="row">
            <div class="col-sm banner1">
              <div class="box box1" style="background-color: #212529;">
                        ...
                        <h4>$<?php echo ucfirst($row['membership_price']); ?> /per Week</h4>
                ...
                <button type="button" class="collapsible text-center dropdown-toggle">
                  ...
                  </svg>Home Club Access </button>
                <div class="content">
                  <p>All opening days and hours</p>
                </div>
                <button type="button" class="collapsible text-center dropdown-toggle">
            ...
            <div class="col-sm banner1">
              <div class="box box3" style="background-color: rgb(39, 88, 88);">
                ...
                <div class="content">
                  <p>Theragun Percussion - recovery and muscle growth</p>
                </div>
                <button type="button" class="collapsible text-center dropdown-toggle">
                ...
                <div class="content">
                  <p>Hydromassage beds – circulation and relaxation</p>
                </div>
                <hr class="featurette-divider">
                <a href="general/register.php">
                  <button type="submit" class="btn btn-dark" style="background-color: black">Join Now</button>
      ...
      <div class=" container-fluid bottom-banner text-center">
        <div class="row">
          <div class="student">
            ...
            <p>In-club only. Visit your local Crunch Club today!</p>
          </div>
          <div class="free-gym">
            <div class="gym">
              <h1>FREE GYM PASS!*</h1>
              <p>No pressure to join. No judgments. Experience everything under one roof with over 1800sqm of fresh and clean fun!* </p>
          ...
          <div class="elders">
            ...
            <p>Crunch Fitness Australia acknowledges the Traditional Owners of the lands across Australia as the continuing custodians of Country and Culture. We pay our respect to First Nations peoples and their Elders, past and present.</p>
          </div>
        </div>
      </div>
    </main>
    <footer class="bg-dark text-white">
      ...
      <!-- Grid container -->
      <!-- Copyright -->
      <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2); font-size:13px"> © 2023 Crunch Fitness Australia. All Rights Reserved. </div>
      <!-- Copyright -->
    </footer>
    <!-- Footer -->
  </body>
